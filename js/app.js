...
const DisplayPhoneDetails = phone => {
    ...
    phoneDetail.innerHTML = `<p> Releasse Date : ${phone.releaseDate ? phone.releaseDate : 'no release date found'}</p>
    <p> other:  ${phone.others ? phone.others.Bluetooth : 'not found'}</p>
